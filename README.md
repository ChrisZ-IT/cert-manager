...
```
export DOMAIN_NAME=domain.local # update with your own domain
export EMAIL_ADDRESS=admin@domain.local # update with your own email address
...
```
I will be creating some automation for cert rotation for external (to k8s) platforms. Since Im using awx it will probably just be a scheduled ansible job to do this.